...
class QuotaApiRepository {
  ...
  Future<BuyerQuotaResponse> fetchQuotaDetail() async {
    return _withAuthorizedAction((accessToken) async {
      ...
      final body = response.data;
      if (body == null) {
        throw Exception('Backend tidak mengembalikan data kuota.');
      }

      return BuyerQuotaResponse.fromJson(body);
    });
  }
